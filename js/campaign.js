...
const campaignRetrieveURL = 'https://campaigns.apps-staging.29next.com/api/v1/campaigns/';
const cartsCreateURL = 'https://campaigns.apps-staging.29next.com/api/v1/carts/'
const ordersURL = 'https://campaigns.apps-staging.29next.com/api/v1/orders/'
